...
export class PriceOracleService {
  ...
  private readonly CASH_TOKEN_ADDRESS = "0x5FbDB2315678afecb367f032d93F642f64180aa3";
  ...
  constructor() {
    ...
    this.volatilityFactors.set("0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512", 0.10); // 10% volatility
    // Private Equity Token - increased volatility for testing
    this.volatilityFactors.set("0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0", 0.15); // 15% volatility
  ...
  private initializeDefaultPrices() {
    ...
    this.prices.set(this.CASH_TOKEN_ADDRESS, { price: 1.0, lastUpdated: new Date() });
    
    // Real Estate Token
    this.prices.set("0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512", { price: 1.0, lastUpdated: new Date() });
    
    // Private Equity Token
    this.prices.set("0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0", { price: 1.0, lastUpdated: new Date() });
  }
  ...
  private simulatePriceChanges() {
    this.prices.forEach((assetPrice, tokenAddress) => {
      ...
      const volatility = this.volatilityFactors.get(tokenAddress) || 0.10; // Default 10% volatility
  ...
  public forceSignificantPriceChange() {
    this.prices.forEach((assetPrice, tokenAddress) => {
      ...
      console.log(`🔥 Forced significant price change for ${tokenAddress}: $${newPrice.toFixed(4)} (${(priceChange * 100).toFixed(2)}%)`);
    });
